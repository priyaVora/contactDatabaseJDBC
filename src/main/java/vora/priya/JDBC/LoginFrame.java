	...
	public void start(final Stage primaryStage) {
		...
		register.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				GridPane gridNew = new Register_LoginFrame(primaryStage, cd);
				...
				for (String account : eachAccountsList) {
					if (new File(pathwayForAccountDatabaseDirectory + account).isDirectory()) {
						try {
							...
							if (new File("C:\\Users\\Prvora89\\workspace_open_source\\Contact-Database-JDBC\\Account_Database_Directory\\"
								...
								cd = new ContactDatabase("C:\\Users\\Prvora89\\workspace_open_source\\Contact-Database-JDBC\\Account_Database_Directory\\" + account +
...
//										
				...
				if (validend3 == true) {
					try {						
						ContactsList contactList = new ContactsList(primaryStage, cd, appendingFileName);
					} catch (Exception e) {
		...
		// #FFE4C4
		grid.setStyle("-fx-background-color: #FFC08B; " + "-fx-background-insets: 10; " + "-fx-background-radius: 20; "
